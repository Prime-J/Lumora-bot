...
const COMMANDS = [
  ...
  { name: "gender",      aliases: [],                category: "game", subcat: "core",       desc: "Set your gender identity: male / female / rather not say",                             usage: ".gender male / female / rather not say" },
  ...
  { name: "fac-link",    aliases: ["faclink","faction-link"], category: "bot", subcat: "utility",    desc: "Re-send your faction group invite link",       usage: ".fac-link" },
  ...
  { name: "tutorial",    aliases: ["tut"],           category: "bot", subcat: "utility",    desc: "Guided tutorial — first hunt with a reward",  usage: ".tutorial" },
  { name: "guide",       aliases: [],                category: "bot", subcat: "utility",    desc: "Full text walkthrough of Lumora",             usage: ".guide" },
  { name: "skip-tutorial",aliases: ["skiptutorial"], category: "bot", subcat: "utility",    desc: "Skip the tutorial, get the world links",     usage: ".skip-tutorial" },
  { name: "t-attack",    aliases: ["tattack"],       category: "bot", subcat: "utility",    desc: "Attack in the tutorial battle (internal)",   usage: ".t-attack" },
  ...
  { name: "wiki-url",    aliases: ["web","dashboard"], category: "bot", subcat: "info",   desc: "Get the Lumora wiki/dashboard link",          usage: ".wiki-url" },
  ...
  { name: "admin",       aliases: [],                category: "bot", subcat: "admin",      desc: "Issue an admin task (token reward)",          usage: ".admin <task>" },
  { name: "claim",       aliases: [],                category: "bot", subcat: "admin",      desc: "Take up a task (no lock — issuer is notified)",  usage: ".claim <task-id>" },
  { name: "admin-name",  aliases: [],                category: "bot", subcat: "admin",      desc: "Set the name shown on admin work",              usage: ".admin-name <name>" },
  { name: "token-give",  aliases: ["tg"],            category: "bot", subcat: "admin",      desc: "Grant tokens to an admin or sudo (RHM/Prime)",  usage: ".token-give @user 2" },
  { name: "task-clear",  aliases: [],                category: "bot", subcat: "admin",      desc: "Clear a task: .task--<id>-cleared or .task-clear <id> @admin", usage: ".task--TABC1-cleared @admin" },
  { name: "tokens",      aliases: [],                category: "bot", subcat: "admin",      desc: "Your admin token balance",                    usage: ".tokens" },
  { name: "admin-lb",    aliases: ["token-lb"],     category: "bot", subcat: "admin",      desc: "Admin token leaderboard",                     usage: ".admin-lb" },
  { name: "token-shop",  aliases: [],                category: "bot", subcat: "admin",      desc: "Spend tokens on in-game goods",               usage: ".token-shop" },
  { name: "token-buy",   aliases: [],                category: "bot", subcat: "admin",      desc: "Buy a token-shop item",                       usage: ".token-buy <item>" },
  { name: "cycle-admin", aliases: [],                category: "bot", subcat: "admin",      desc: "Run the admin cycle — demote the lowest",     usage: ".cycle-admin" },
